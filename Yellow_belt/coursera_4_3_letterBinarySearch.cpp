...
pair<RandomIt, RandomIt> FindStartsWith(
    ...
    char prefix){
    RandomIt ub = upper_bound(range_begin, range_end, prefix, [](char a, typename RandomIt::value_type b){
                    if (a - b[0] < 0){
                        return true;
                    } else {
                        return false;
    ...
    RandomIt lb = lower_bound(range_begin, range_end, prefix, [](typename RandomIt::value_type b, char a){
                    if (b[0] - a < 0){
                        return true;
                    } else {
                        return false;
